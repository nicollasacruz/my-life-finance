            ...
            <div className="px-4 sm:px-6 py-4 sm:py-6 space-y-4 sm:space-y-6 overflow-y-auto flex-1">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-4 gap-3">
                  ...
                  <button
                    type="button"
                    onClick={() => setFormData({ ...formData, type: AccountType.ONE_TIME })}
                    className={`p-4 rounded-lg border-2 transition-all ${
                      formData.type === AccountType.ONE_TIME
                  ...
                  >
                    <div className="flex items-center gap-3 sm:flex-col sm:gap-0 sm:text-center">
                      <div className="text-2xl flex-shrink-0 sm:mb-2">🛒</div>
                      <div className="flex-1 sm:flex-none text-left sm:text-center">
                        <div className="font-semibold text-gray-900 text-sm mb-0.5">Compra Única</div>
                        <div className="text-xs text-gray-500">
                          Uma vez, mês atual
                        </div>
                      </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={(e) => setFormData({ ...formData, oneTimeAmount: e.target.value })}
                        className="w-full pl-8 pr-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        placeholder="0.00"
                      />
                    </div>
